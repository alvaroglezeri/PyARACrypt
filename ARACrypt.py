...
# Author: Álvaro G.E. (github.com/alvaroglezeri)
# Version: v.1.1
    ...
    def _transform_byte(self, byte: int) -> int:
        ...
        for _ in range(8):
            if self.lfsrA & 0x00000001:
                ...
                self.lfsrA = (((self.lfsrA ^ self.maskA) >> 1) | self.rot1A) & 0xFFFFFFFF
                if self.lfsrB & 0x00000001:
                    self.lfsrB = (((self.lfsrB ^ self.maskB) >> 1) | self.rot1B) & 0xFFFFFFFF
                    outB = 1
                else:
                ...
                if self.lfsrC & 0x00000001:
                    self.lfsrC = (((self.lfsrC ^ self.maskC) >> 1) | self.rot1C) & 0xFFFFFFFF
                    outC = 1
                else:
